...
#ifndef DLP4500_API_H
#define DLP4500_API_H
...
int LCR_SetDisplay(rectangl croppedArea, rectangl displayArea);
int LCR_GetDisplay(rectangl *pCroppedArea, rectangl *pDisplayArea);
